...
1. **首页（日历视图）**：月视图/周视图/日视图/年视图切换、事件展示、天气显示、快速导航
...
7. **搜索页**：关键词搜索、筛选条件、搜索结果列表
8. **设置页**：主题切换、提醒设置、导入导出、账户管理、AI设置、天气设置、闹钟设置
9. **小组件**：桌面快捷查看、快速添加事件
...
| 首页    | 日历展示区   | 根据当前视图模式渲染日历网格，展示事件标记和天气图标       |
